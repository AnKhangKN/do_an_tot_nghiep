...
const NotificationPage = () => {
  ...
  return (
    <div className="space-y-6 font-sans">
      ...
      {toastMessage && (
        <div
          className={`fixed top-6 right-6 z-[99999] flex items-center gap-3 rounded-2xl px-5 py-3.5 shadow-lg border transition duration-300 animate-slide-in ${toastMessage.type === "error"
