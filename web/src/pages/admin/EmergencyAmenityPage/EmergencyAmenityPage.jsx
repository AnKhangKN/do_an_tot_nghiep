...
export default function EmergencyAmenityPage() {
  const [activeTab, setActiveTab] = useState('points'); // 'points' | 'categories'
  ...
  }, [activeTab, pointsPage, statusFilter]);
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Quản lý danh mục và các điểm tiện ích khẩn cấp (Sửa xe, Trạm xăng, Y tế, Vá lốp) trên toàn hệ thống.
          </p>
        </div>
        ...
        <div className="fixed inset-0 bg-black/40 backdrop-blur-xs flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-3xl max-w-lg w-full p-6 shadow-2xl space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="p-3.5 bg-gray-50 rounded-2xl space-y-1">
                ...
                <div>
                  ...
                  >
                    ...
                    {selectedPoint.status === 'APPROVED' ? 'Đã duyệt (Công khai)' : selectedPoint.status === 'PENDING' ? 'Chờ Admin duyệt' : 'Đã từ chối'}
                  </span>
                </div>
              </div>
              ...
              <div className="p-3.5 bg-gray-50 rounded-2xl space-y-1 col-span-1 md:col-span-2">
