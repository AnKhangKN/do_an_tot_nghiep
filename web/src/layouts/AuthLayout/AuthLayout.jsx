      ...
      <div className="grid min-h-screen lg:grid-cols-[0.9fr_1.1fr]">
        <aside className="relative hidden overflow-hidden bg-gray-950 px-10 py-8 text-white lg:flex lg:flex-col">
          ...
          <div className="relative flex items-center gap-3">
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-white dark:bg-gray-100 text-gray-950 shadow-lg">
              <PiLifebuoyFill size={24} />
            </div>

            <div>
              <h1 className="text-lg font-bold">Rescue Admin</h1>
              <p className="text-xs text-gray-400 dark:text-gray-700">Hệ thống quản lý cứu hộ</p>
            </div>
          </div>

          <div className="relative mt-auto max-w-md">
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/10 px-4 py-2 text-sm text-gray-200 dark:text-gray-800">
            ...
            <div className="mt-8 grid grid-cols-3 gap-3">
              <div className="rounded-2xl border border-white/10 bg-white/10 p-4">
                ...
                <p className="mt-1 text-xs text-gray-400 dark:text-gray-700">Giám sát</p>
              </div>

              <div className="rounded-2xl border border-white/10 bg-white/10 p-4">
                <PiMapPinFill className="mb-3 text-blue-300" size={24} />
                <p className="text-2xl font-bold">Live</p>
                <p className="mt-1 text-xs text-gray-400 dark:text-gray-700">Bản đồ</p>
              </div>

              <div className="rounded-2xl border border-white/10 bg-white/10 p-4">
                <PiLockKeyFill className="mb-3 text-emerald-300" size={24} />
                <p className="text-2xl font-bold">Admin</p>
                <p className="mt-1 text-xs text-gray-400 dark:text-gray-700">Bảo mật</p>
              </div>
            </div>
          </div>

          <p className="relative mt-10 text-xs text-gray-500 dark:text-gray-700">© 2026 AnKhang</p>
        </aside>
