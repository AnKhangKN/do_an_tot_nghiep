...
import { listenKickedEvent } from "./features/session/sessionSocket";
...
export const subscribeKickedEvent = (onKicked) => {
  const socket = getSocketInstance();
  return listenKickedEvent(socket, onKicked);
};
